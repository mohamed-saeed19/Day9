    ...
    <div>
      ...
      {movieDetails ? (
        <div className="row">
          ...
          <div className="col-md-8">
            ...
            <ul className="my-4">
              ...
              <li className="py-2">
                Original_language :{" "}
                {movieDetails.original_language === "en" ? "English" : "en"}
              </li>
        ...
        <div className="vh-100 d-flex align-items-center">
          <h1>
            I'm sorry, there is no content at the moment, please try again
          </h1>
        </div>
      )}
    </div>
...
export default MovieDetailsCompleted;
